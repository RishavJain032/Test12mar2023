...
function App() {
  return (
    <div className="App" style = {{marginLeft : "20%",width : "800px",height : "100%",border : "2px solid black",margin : "10px",padding : "10px",dispaly :"flex",justifyContent :"center",alignItems : "center"}}>
      <Navbar />
      <Bussiness />
      <Features />
      <Featurehead />
